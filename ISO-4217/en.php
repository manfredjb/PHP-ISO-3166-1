...
return [
    ...
    'ANG' => [
        'iso_3166_1_numeric' => 532, 
        'name' => 'Netherlands Antillean guilder', 
        'country_name' => ' Curaçao (CW),  Sint Maarten (SX)'
    ],
    'AOA' => [
        'iso_3166_1_numeric' => 973, 
        'name' => 'Angolan kwanza', 
        'country_name' => ' Angola'
    ],
    'ARS' => [
    ...
    'AUD' => [
        ...
        'country_name' => ' Australia,  Christmas Island (CX),  Cocos (Keeling) Islands (CC),  Heard Island and McDonald Islands (HM),  Kiribati (KI),  Nauru (NR),  Norfolk Island (NF),  Tuvalu (TV)'
    ],
    'AWG' => [
    ...
    'AZN' => [
        'iso_3166_1_numeric' => 944, 
        'name' => 'Azerbaijani manat', 
        'country_name' => ' Azerbaijan'
    ],
    'BAM' => [
        'iso_3166_1_numeric' => 977, 
    ...
    'BOV' => [
        'iso_3166_1_numeric' => 984, 
        'name' => 'Bolivian Mvdol (funds code)', 
        'country_name' => ' Bolivia'
    ],
    'BRL' => [
        'iso_3166_1_numeric' => 986, 
        'name' => 'Brazilian real', 
        'country_name' => ' Brazil'
    ],
    'BSD' => [
    ...
    'CDF' => [
        'iso_3166_1_numeric' => 976, 
        'name' => 'Congolese franc', 
        'country_name' => ' Democratic Republic of the Congo'
    ],
    'CHE' => [
        'iso_3166_1_numeric' => 947, 
    ...
    'CHF' => [
        ...
        'name' => 'Swiss franc', 
        'country_name' => '  Switzerland,  Liechtenstein (LI)'
    ],
    'CHW' => [
        'iso_3166_1_numeric' => 948, 
        'name' => 'WIR Franc (complementary currency)', 
        'country_name' => '  Switzerland'
    ],
    'CLF' => [
        'iso_3166_1_numeric' => 990, 
    ...
    'DKK' => [
        ...
        'name' => 'Danish krone', 
        'country_name' => ' Denmark,  Faroe Islands (FO),  Greenland (GL)'
    ],
    'DOP' => [
    ...
    'FKP' => [
        ...
        'country_name' => ' Falkland Islands (pegged to GBP 1:1)'
    ],
    'GBP' => [
        'iso_3166_1_numeric' => 826, 
        'name' => 'Pound sterling', 
        'country_name' => ' United Kingdom, the  Isle of Man (IM, see Manx pound),  Jersey (JE, see Jersey pound), and  Guernsey (GG, see Guernsey pound)'
    ],
    'GEL' => [
        'iso_3166_1_numeric' => 981, 
        'name' => 'Georgian lari', 
        'country_name' => ' Georgia'
    ],
    'GHS' => [
        'iso_3166_1_numeric' => 936, 
        'name' => 'Ghanaian cedi', 
        'country_name' => ' Ghana'
    ],
    'GIP' => [
        ...
        'country_name' => ' Gibraltar (pegged to GBP 1:1)'
    ],
    'GMD' => [
    ...
    'NOK' => [
        ...
        'country_name' => ' Norway,  Svalbard and  Jan Mayen (SJ),  Bouvet Island (BV)'
    ],
    'NPR' => [
    ...
    'NZD' => [
        ...
        'country_name' => ' New Zealand,  Cook Islands (CK),  Niue (NU),  Pitcairn Islands (PN; see also Pitcairn Islands dollar),  Tokelau (TK)'
    ],
    'OMR' => [
    ...
    'RON' => [
        'iso_3166_1_numeric' => 946, 
        'name' => 'Romanian leu', 
        'country_name' => ' Romania'
    ],
    'RSD' => [
        'iso_3166_1_numeric' => 941, 
        'name' => 'Serbian dinar', 
        'country_name' => ' Serbia'
    ],
    'RUB' => [
    ...
    'SHP' => [
        ...
        'country_name' => ' Saint Helena (SH-SH),  Ascension Island (SH-AC),  Tristan da Cunha'
    ],
    'SLL' => [
    ...
    'TJS' => [
        'iso_3166_1_numeric' => 972, 
        'name' => 'Tajikistani somoni', 
        'country_name' => ' Tajikistan'
    ],
    'TMT' => [
        'iso_3166_1_numeric' => 934, 
    ...
    'XAF' => [
        'iso_3166_1_numeric' => 950, 
        'name' => 'CFA franc BEAC', 
        'country_name' => ' Cameroon (CM),  Central African Republic (CF),  Republic of the Congo (CG),  Chad (TD),  Equatorial Guinea (GQ),  Gabon (GA)'
    ],
    'XAG' => [
        'iso_3166_1_numeric' => 961, 
        'name' => 'Silver (one troy ounce)', 
        'country_name' => ''
    ],
    'XAU' => [
        'iso_3166_1_numeric' => 959, 
        'name' => 'Gold (one troy ounce)', 
        'country_name' => ''
    ],
    'XBA' => [
        'iso_3166_1_numeric' => 955, 
        'name' => 'European Composite Unit (EURCO) (bond market unit)', 
        'country_name' => ''
    ],
    'XBB' => [
        'iso_3166_1_numeric' => 956, 
        'name' => 'European Monetary Unit (E.M.U.-6) (bond market unit)', 
        'country_name' => ''
    ],
    'XBC' => [
        'iso_3166_1_numeric' => 957, 
        'name' => 'European Unit of Account 9 (E.U.A.-9) (bond market unit)', 
        'country_name' => ''
    ],
    'XBD' => [
        'iso_3166_1_numeric' => 958, 
        'name' => 'European Unit of Account 17 (E.U.A.-17) (bond market unit)', 
        'country_name' => ''
    ],
    'XCD' => [
        'iso_3166_1_numeric' => 951, 
        'name' => 'East Caribbean dollar', 
        'country_name' => ' Anguilla (AI),  Antigua and Barbuda (AG),  Dominica (DM),  Grenada (GD),  Montserrat (MS),  Saint Kitts and Nevis (KN),  Saint Lucia (LC),  Saint Vincent and the Grenadines (VC)'
    ],
    'XDR' => [
        'iso_3166_1_numeric' => 960, 
        'name' => 'Special drawing rights', 
        'country_name' => 'International Monetary Fund'
    ],
    'XOF' => [
        'iso_3166_1_numeric' => 952, 
        'name' => "CFA franc BCEAO', 
        'country_name' => ' Benin (BJ),  Burkina Faso (BF),  Côte d'Ivoire (CI),  Guinea-Bissau (GW),  Mali (ML),  Niger (NE),  Senegal (SN),  Togo (TG)"
    ],
    'XPD' => [
        'iso_3166_1_numeric' => 964, 
        'name' => 'Palladium (one troy ounce)', 
        'country_name' => ''
    ],
    'XPF' => [
        'iso_3166_1_numeric' => 953, 
        'name' => 'CFP franc (franc Pacifique)', 
        'country_name' => 'French territories of the Pacific Ocean:  French Polynesia (PF),  New Caledonia (NC),  Wallis and Futuna (WF)'
    ],
    'XPT' => [
        'iso_3166_1_numeric' => 962, 
        'name' => 'Platinum (one troy ounce)', 
        'country_name' => ''
    ],
    'XSU' => [
        'iso_3166_1_numeric' => 994, 
        'name' => 'SUCRE', 
        'country_name' => 'Unified System for Regional Compensation (SUCRE)[9]'
    ],
    'XTS' => [
        'iso_3166_1_numeric' => 963, 
        'name' => 'Code reserved for testing purposes', 
        'country_name' => ''
    ],
    'XUA' => [
        'iso_3166_1_numeric' => 965, 
        'name' => 'ADB Unit of Account', 
        'country_name' => 'African Development Bank[10]'
    ],
    'XXX' => [
